...
if cfg.hardness_ratio_plot:
    ...
    hr=list((lambda a,b : a/b ,flux_1000_300000,flux_300_1000))[1]
    ...
    hre=list((lambda a,b,c,d:sqrt(((c/b)**2)+(((-(a)/b**2)*d)**2)),flux_1000_300000,flux_300_1000,flux_1000_300000_err,flux_300_1000_err))[1]
