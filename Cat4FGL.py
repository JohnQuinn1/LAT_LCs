    ...
    def select_object(self, name, field="ASSOC1"):
        ...
        try:
            ...
            for i,n in enumerate(names):
                ...
                Cat4logger.critical("Cat4FGL:select_object() did not find match for "+str(name)+ " - exiting")
                try:
...
print("I kept going no matter what, this is the end of the program script") 
#the only thing that actually stops the program now is invalid number of arguments given to argparse functions
...
# import astropy.units as u
# from gammapy.spectrum.models import PowerLaw
# var=gammapy.spectrum.models.LogParabola(amplitude=1.9244011e-11*u.Unit('cm-2 s-1 TeV-1'),reference=1286.4747*u.TeV,alpha=1.7230468,beta=0.022921344)
# print(var)
# print(var.integral(float(1)*u.TeV,float(2)*u.TeV))
